...
public class GamePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        //lp.add(b.chc, new Integer(0), 0);

        lp.add(b.getCheckerSet1().getChecker(0),new Integer(2), 0);

        b.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/board.jpg"))); // NOI18N
        ...
        lpLayout.setHorizontalGroup(
            ...
            .addComponent(b, javax.swing.GroupLayout.PREFERRED_SIZE, 1022, Short.MAX_VALUE)
        );
        lpLayout.setVerticalGroup(
            lpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(b, javax.swing.GroupLayout.PREFERRED_SIZE, 802, Short.MAX_VALUE)
        );
